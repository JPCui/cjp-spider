...
import cn.cjp.sina.weibo.http.access.SWHttpClientAccessCore;
...
public class GetFansSpider extends Thread {
	...
	SWHttpClientAccessCore accessCore = null;
	...
	public GetFansSpider(Map<String, String> accounts) {
		accessCore = SWHttpClientAccessCore.getInstance(accounts);
	}
	 ...
	 * 打印队列
	 */
	private synchronized void printSpiderList() {
		synchronized (logger) {
			logger.error("======================");
