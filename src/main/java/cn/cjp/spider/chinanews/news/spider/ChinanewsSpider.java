...
import cn.cjp.spider.chinanews.news.analyzer.HtmlAnalyzer;
import cn.cjp.spider.chinanews.news.domain.ChinanewsDomain;
import cn.cjp.spider.chinanews.news.repo.ChinanewsRepo;
...
public class ChinanewsSpider {
	...
	public void getNewsDomainFromUrls() {
		...
		synchronized (redisListOps) {
			...
			urlFrom = redisListOps.rpop(ChinanewsSpider.SPIDER_LIST_REDIS_KEY);
		}
		try {
			// 可能会因网速问题，出现socket异常
