package cn.cjp.spider.sina.weibo.http.access;
 ...
 * @deprecated
 * 考虑纳入多线程的新浪微博爬虫核心代码
 * <br> use {@link SWHttpClientAccessCore} instead
 * @author REAL
 *
 */
public class SWAccessCore {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SWAccessCore.class);

	private Connection conn = null;

	private SWAccessCore() {
	}
	 ...
	 * @return
	 */
	public static SWAccessCore getInstance(String username, String password) {
		SWAccessCore sinaWeiboAccessCore = new SWAccessCore();
