...
import cn.cjp.spider.sina.weibo.analyzer.GetFansAnalyzer;
import cn.cjp.spider.sina.weibo.domain.UserDomain;
import cn.cjp.spider.sina.weibo.http.access.SWAccessCore;
...
public class SinaWeiboAccessCoreThreadDemo {
	...
	public void init() {
		...
		accessCore = SWAccessCore.getInstance(username, password);
		// 初始化等待队列
